    ...
    <div className="home-container">
      ...
      <div className="home-hero">
        ...
        <div className="home-container01">
          <div className="home-container02">
            <h1 className="home-text">¡Tu nuevo empleo esta aqui!</h1>
            <span className="home-text01">
              <span>
                Buscamos gente con tu talento. Ingresa tus datos y te
                contactaremos. Da el primer paso para tu crecimiento profesional
              </span>
            </span>
            <form
              action="https://gufze37jzpkuvsf7ehbyszvr540fgcjs.lambda-url.us-east-1.on.aws/"
              method="POST"
            ...
            >
              <input
                ...
                required="true"
                placeholder="Nombre"
                className="contactFormInput input"
              />
              <input
                type="tel"
                required="true"
                ...
                className="contactFormInput input"
              />
              <button className="home-button button contactFormInput">
                Contáctame
              </button>
            </form>
          </div>
      ...
      <div className="home-section1">
        <div className="home-container03">
          <div className="home-container04">
            <h6 className="home-text03">
              <span>WITH BURNED SOLES</span>
              <span></span>
            </h6>
            <h3 className="home-text06 healine">
              I&apos;ve risen with the soles burned
            </h3>
            <span className="home-text07 textXL">
          ...
          <div className="home-cards-container">
            <div className="home-card1">
              ...
              <h6 className="home-text09 textXL">Awarded Agency</h6>
            ...
            <div className="home-card2">
              ...
              <h6 className="home-text11 textXL">Free Revisions</h6>
            ...
            <div className="home-card3">
              ...
              <h6 className="home-text13 textXL">Verified Company</h6>
          ...
          <div className="home-work-with-us">
            <div className="home-container08">
              ...
              <h3 className="home-text15 healine">
              ...
              <span className="home-text21">Check Notus PRO React!</span>
            </div>
            <div className="home-container10">
              ...
              <div className="home-container12">
                <h4 className="home-text22 healine">
                  <span className="home-text23">Top Notch Services</span>
                  <br></br>
                </h4>
      ...
      <div className="home-section2">
        <div className="home-container13">
          ...
          <h2 className="home-text26 text2XL">
            <span className="home-text27">
              You need to fight like David with Goliath
            </span>
            <br></br>
          </h2>
          <span className="home-text28 textXL">
        ...
        <div className="home-growing-company-section">
          ...
          <div className="home-container14">
            ...
            <h3 className="home-text29 healine">A growing company</h3>
            ...
            <div className="home-container16">
              ...
              <span className="home-text31">Carefully crafted components</span>
            </div>
            <div className="home-container18">
              ...
              <span className="home-text32">Amazing page examples</span>
            </div>
            <div className="home-container20">
              ...
              <span className="home-text33">Dynamic components</span>
            </div>
          </div>
        </div>
        <div className="home-container22">
          <h6 className="home-text34">
            <span>THE ENTOURAGE</span>
          </h6>
          <h3 className="home-text36 healine">
            It is everything, and it won&apos;t change
          </h3>
          <span className="home-text37 textXL">
